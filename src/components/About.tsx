...
const About = ({ sectionTitle, headline, subtitle, description, imageSrc, imageAlt }: AboutProps) => {
  const { t } = useApp();

  return (
    <section id="about" className="py-12 sm:py-20 bg-gray-50 dark:bg-gray-900 pt-8 pb-10 mb-10">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12 sm:mb-20 pt-10 mt-10">
          <h2 className="text-display font-heading font-bold text-black dark:text-white mb-6 tracking-tight">

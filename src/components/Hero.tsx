      ...
      <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 bg-gray-700 dark:bg-gray-300 text-white dark:text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
          >
        ...
        <div className="mt-12 flex justify-center space-x-12">
          <a href="https://linkedin.com/in/dayvsonmarques" className="text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors">
          ...
          <a href="mailto:dayvson.marques@gmail.com" className="text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors">

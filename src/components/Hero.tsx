        ...
        <div className="mt-12 flex justify-center space-x-8">
          <div className="relative group">
            <a 
              ...
              className="social-icon flex items-center justify-center w-20 h-20 bg-white dark:bg-gray-100 rounded-full shadow-lg text-gray-600 hover:text-blue-600 transition-all duration-300 hover:shadow-xl hover:scale-105"
          ...
          <div className="relative group">
            <a 
              ...
              className="social-icon flex items-center justify-center w-20 h-20 bg-white dark:bg-gray-100 rounded-full shadow-lg text-gray-600 hover:text-gray-900 transition-all duration-300 hover:shadow-xl hover:scale-105"
          ...
          <div className="relative group">
            <a 
              ...
              className="social-icon flex items-center justify-center w-20 h-20 bg-white dark:bg-gray-100 rounded-full shadow-lg text-gray-600 hover:text-red-600 transition-all duration-300 hover:shadow-xl hover:scale-105"
          ...
          <div className="relative group">
            <a 
              ...
              className="social-icon flex items-center justify-center w-20 h-20 bg-white dark:bg-gray-100 rounded-full shadow-lg text-gray-600 hover:text-yellow-500 transition-all duration-300 hover:shadow-xl hover:scale-105"
